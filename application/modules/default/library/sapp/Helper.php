                ...
                if($tot_rec_cnt > 0)
                {
                    for($i=2; $i <= $sizeOfWorksheet; $i++ )
                    {
                        ...
                        $text = "<div style='padding: 0; text-align: left; font-size:14px; font-family:Arial, Helvetica, sans-serif;'>				
                                        ...
                                        <div style='padding:20px 0 0 0;color:#3b3b3b;'>You have been added to ". APPLICATION_NAME.". The login credentials for your Mahathi Employee Portal account are:</div>
                                        ...
                                        <div style='padding:20px 0 10px 0;'>Please <a href='".BASE_URL."index/popup' target='_blank' style='color:#b3512f;'>click here</a> to login  to your Mahathi Employee Portal account.</div>

                                </div>";
                        $options['subject'] = APPLICATION_NAME.': Login Credentials';
                        $options['header'] = 'Greetings from Mahathi Infotech';
