...
if($exists)
{
		...
		?>  
<?php }else{?>
			<div class="error_mess">Your application is not updated .Please check your internet connection to update or visit mahathiinfotech.com to update your system.</div>
<?php }?>		
